...
float delta = 0;
float movementSpeed = 0; // units per second
void updateDelta(double elapsedSeconds) { delta = delta + movementSpeed * elapsedSeconds; }double lastTimeStamp = glfwGetTime();
...
int main(int argc, const char * argv[]) {
	...
	myModel = gps::Model3D("objects\\12140_Skull_v3_L2.obj");
